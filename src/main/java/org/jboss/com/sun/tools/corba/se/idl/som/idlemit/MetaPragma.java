...
package org.jboss.com.sun.tools.corba.se.idl.som.idlemit;
import java.util.Vector;
import org.jboss.com.sun.tools.corba.se.idl.som.cff.Messages;
/**
 ...
 * is org.jboss.com.sun.tools.corba.se.idl.som.idlemit.MetaPragma.metaKey
 *
 ...
 */
public class MetaPragma extends org.jboss.com.sun.tools.corba.se.idl.PragmaHandler {
    /* Class variables */

    /* key to access the Cached meta info in org.jboss.com.sun.tools.corba.se.idl.SymtabEntry */
    public static int metaKey = org.jboss.com.sun.tools.corba.se.idl.SymtabEntry.getVariableKey();
    ...
    public boolean process(String pragma, String currentToken) {
        ...
        org.jboss.com.sun.tools.corba.se.idl.SymtabEntry entry ;
        String msg;
        try {
            entry = scopedName();
            if ( entry == null){
...
// System.out.println("exception in MetaPragma");
     ...
     */
    static public void processForward(org.jboss.com.sun.tools.corba.se.idl.ForwardEntry forwardEntry){
        ...
        org.jboss.com.sun.tools.corba.se.idl.SymtabEntry forwardInterface = forwardEntry.type();
