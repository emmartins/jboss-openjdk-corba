...
package org.jboss.com.sun.corba.se.impl.naming.pcosnaming;
...
import org.jboss.com.sun.corba.se.impl.naming.cosnaming.NamingContextDataStore;
import org.jboss.com.sun.corba.se.impl.naming.cosnaming.NamingUtils;

import org.jboss.com.sun.corba.se.impl.naming.namingutil.INSURLHandler;
...
import org.jboss.com.sun.corba.se.impl.logging.NamingSystemException;
    ...
    implements NamingContextDataStore, Serializable
{
    ...
    private transient org.jboss.com.sun.corba.se.impl.naming.cosnaming.InterOperableNamingImpl insImpl;
        ...
        throws Exception
    {
        ...
        insImpl =
            new org.jboss.com.sun.corba.se.impl.naming.cosnaming.InterOperableNamingImpl();
    }

    org.jboss.com.sun.corba.se.impl.naming.cosnaming.InterOperableNamingImpl getINSImpl( )
    {
        if( insImpl == null )
        {
