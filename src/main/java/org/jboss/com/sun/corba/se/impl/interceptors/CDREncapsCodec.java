    ...
    implements Codec
{
    ...
    public CDREncapsCodec( ORB orb, int major, int minor ) {
        ...
        wrapper = ORBUtilSystemException.get(
            (org.jboss.com.sun.corba.se.spi.orb.ORB)orb, CORBALogDomains.RPC_PROTOCOL ) ;
        ...
        throws InvalidTypeForEncoding
    {
        ...
        EncapsOutputStream cdrOut = new EncapsOutputStream(
            (org.jboss.com.sun.corba.se.spi.orb.ORB)orb, giopVersion );
        ...
        throws FormatMismatch
    {
        ...
        try {
            ...
            any = new AnyImpl( (org.jboss.com.sun.corba.se.spi.orb.ORB)orb );
