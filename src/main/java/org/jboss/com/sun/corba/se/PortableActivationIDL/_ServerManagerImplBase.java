...
/**
* org.jboss.com.sun.corba/se/PortableActivationIDL/_ServerManagerImplBase.java .
...
public abstract class _ServerManagerImplBase extends org.omg.CORBA.portable.ObjectImpl
                implements org.jboss.com.sun.corba.se.PortableActivationIDL.ServerManager, org.omg.CORBA.portable.InvokeHandler
{
  	...
  	*/
       case 0:  // PortableActivationIDL/Activator/registerServer
       {
         try {
           ...
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerProxy serverObj = org.jboss.com.sun.corba.se.PortableActivationIDL.ServerProxyHelper.read (in);
           this.registerServer (serverId, serverObj);
           out = $rh.createReply();
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write (out, $ex);
         }
         break;
       }
  	...
  	*/
       case 2:  // PortableActivationIDL/Activator/registerORB
       {
         try {
           ...
           org.jboss.com.sun.corba.se.PortableActivationIDL.ORBProxy orb = org.jboss.com.sun.corba.se.PortableActivationIDL.ORBProxyHelper.read (in);
           org.jboss.com.sun.corba.se.PortableActivationIDL.EndPointInfo endPointInfo[] = org.jboss.com.sun.corba.se.PortableActivationIDL.EndpointInfoListHelper.read (in);
           this.registerORB (serverId, orbId, orb, endPointInfo);
           out = $rh.createReply();
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPoint $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPointHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ORBAlreadyRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ORBAlreadyRegisteredHelper.write (out, $ex);
         }
         break;
       }
  	...
  	*/
       case 5:  // PortableActivationIDL/Activator/activate
       {
         try {
           ...
           out = $rh.createReply();
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyActive $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyActiveHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDown $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDownHelper.write (out, $ex);
         }
         break;
       }
  	...
  	*/
       case 6:  // PortableActivationIDL/Activator/shutdown
       {
         try {
           ...
           out = $rh.createReply();
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotActive $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotActiveHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write (out, $ex);
         }
  	...
  	*/
       case 7:  // PortableActivationIDL/Activator/install
       {
         try {
           ...
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDownHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyInstalled $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyInstalledHelper.write (out, $ex);
         }
         break;
       }
  	...
  	*/
       case 8:  // PortableActivationIDL/Activator/uninstall
       {
         try {
           ...
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDownHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyUninstalled $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyUninstalledHelper.write (out, $ex);
         }
         break;
       }
  ...
  /** list active servers
  	*/
       case 9:  // PortableActivationIDL/Activator/getActiveServers
       {
         ...
         out = $rh.createReply();
         org.jboss.com.sun.corba.se.PortableActivationIDL.ServerIdsHelper.write (out, $result);
         break;
       }
  	...
  	*/
       case 10:  // PortableActivationIDL/Activator/getORBNames
       {
         try {
           ...
           out = $rh.createReply();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ORBidListHelper.write (out, $result);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write (out, $ex);
         }
  	...
  	*/
       case 12:  // PortableActivationIDL/Locator/locateServer
       {
         try {
           ...
           org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerType $result = null;
           $result = this.locateServer (serverId, endPoint);
           out = $rh.createReply();
           org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerTypeHelper.write (out, $result);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPoint $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPointHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
  	...
  	*/
       case 13:  // PortableActivationIDL/Locator/locateServerForORB
       {
         try {
           String serverId = org.omg.PortableInterceptor.ServerIdHelper.read (in);
           String orbId = org.omg.PortableInterceptor.ORBIdHelper.read (in);
           org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB $result = null;
           $result = this.locateServerForORB (serverId, orbId);
           out = $rh.createReply();
           org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORBHelper.write (out, $result);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.InvalidORBid $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.InvalidORBidHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDown $ex) {
  ...
  /** Useful from external BadServerIdHandlers which need
  	...
  	*/
       ...
       {
         try {
           org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB location = org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORBHelper.read (in);
           String endPointType = in.read_string ();
           int $result = (int)0;
