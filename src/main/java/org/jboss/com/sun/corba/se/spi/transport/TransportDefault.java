...
import org.jboss.com.sun.corba.se.spi.transport.ReadTimeoutsFactory;
import org.jboss.com.sun.corba.se.spi.orb.ORB ;
import org.jboss.com.sun.corba.se.spi.ior.IOR ;

// Internal imports, not used in the interface to this package
import org.jboss.com.sun.corba.se.impl.protocol.CorbaClientDelegateImpl ;
import org.jboss.com.sun.corba.se.impl.transport.CorbaContactInfoListImpl;
import org.jboss.com.sun.corba.se.impl.transport.ReadTCPTimeoutsImpl;
        ...
        return new CorbaContactInfoListFactory() {
            ...
            public CorbaContactInfoList create( IOR ior ) {
                return new CorbaContactInfoListImpl(
                    (org.jboss.com.sun.corba.se.spi.orb.ORB)broker, ior ) ;
            }
        };
    }
        ...
        return new ClientDelegateFactory() {
            public CorbaClientDelegate create( CorbaContactInfoList info ) {
                return new CorbaClientDelegateImpl(
                    (org.jboss.com.sun.corba.se.spi.orb.ORB)broker, info ) ;
            }
        };
    }
