...
/**
* org.jboss.com.sun.corba/se/PortableActivationIDL/_ServerManagerStub.java .
...
/** Interface used to combine the Activator and Locator when both are
    ...
    */
public class _ServerManagerStub extends org.omg.CORBA.portable.ObjectImpl implements org.jboss.com.sun.corba.se.PortableActivationIDL.ServerManager
{


  /** A new ORB started server registers itself with the Activator
  	*/
  public void registerServer (String serverId, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerProxy serverObj) throws org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered
  {
            ...
            try {
                ...
                org.jboss.com.sun.corba.se.PortableActivationIDL.ServerProxyHelper.write ($out, serverObj);
                $in = _invoke ($out);
                return;
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.read ($in);
                else
  ...
  /** Called whenever an ORB instance is created.  This registers
  	...
  	*/
  public void registerORB (String serverId, String orbId, org.jboss.com.sun.corba.se.PortableActivationIDL.ORBProxy orb, org.jboss.com.sun.corba.se.PortableActivationIDL.EndPointInfo[] endPointInfo) throws org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPoint, org.jboss.com.sun.corba.se.PortableActivationIDL.ORBAlreadyRegistered
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                org.jboss.com.sun.corba.se.PortableActivationIDL.ORBProxyHelper.write ($out, orb);
                org.jboss.com.sun.corba.se.PortableActivationIDL.EndpointInfoListHelper.write ($out, endPointInfo);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    ...
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPointHelper.read ($in);
                else if (_id.equals ("IDL:PortableActivationIDL/ORBAlreadyRegistered:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ORBAlreadyRegisteredHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  /** If the server is not running, start it up.  This is allowed
  	...
  	*/
  public void activate (String serverId) throws org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyActive, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDown
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerAlreadyActive:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyActiveHelper.read ($in);
                    ...
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDownHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                activate (serverId        );
  ...
  /** If the server is running, shut it down
  	*/
  public void shutdown (String serverId) throws org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotActive, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerNotActive:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotActiveHelper.read ($in);
                else if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
  ...
  /** Invoke the server install hook.  If the server is not 
  	...
  	*/
  public void install (String serverId) throws org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDown, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyInstalled
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    ...
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyInstalledHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                install (serverId        );
  ...
  /** Invoke the server uninstall hook.  If the server is not
  	...
  	*/
  public void uninstall (String serverId) throws org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDown, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyUninstalled
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    ...
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyUninstalledHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                uninstall (serverId        );
  ...
  public String[] getActiveServers ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = org.jboss.com.sun.corba.se.PortableActivationIDL.ServerIdsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  /** list all registered ORBs for a server
  	*/
  public String[] getORBNames (String serverId) throws org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                org.omg.PortableInterceptor.ServerIdHelper.write ($out, serverId);
                $in = _invoke ($out);
                String $result[] = org.jboss.com.sun.corba.se.PortableActivationIDL.ORBidListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  /** locate server - returns the port with a specific type for all registered
  	...
  	*/
  public org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerType locateServer (String serverId, String endPoint) throws org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPoint, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDown
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = _invoke ($out);
                org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerType $result = org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerTypeHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  /** locate server - returns all ports registered with a specified ORB for
  	...
  	* Starts the server if it is not already running.
  	*/
  public org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB locateServerForORB (String serverId, String orbId) throws org.jboss.com.sun.corba.se.PortableActivationIDL.InvalidORBid, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDown
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                org.omg.PortableInterceptor.ORBIdHelper.write ($out, orbId);
                $in = _invoke ($out);
                org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB $result = org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORBHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:PortableActivationIDL/InvalidORBid:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.InvalidORBidHelper.read ($in);
                else if (_id.equals ("IDL:PortableActivationIDL/ServerNotRegistered:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.read ($in);
                else if (_id.equals ("IDL:PortableActivationIDL/ServerHeldDown:1.0"))
                    throw org.jboss.com.sun.corba.se.PortableActivationIDL.ServerHeldDownHelper.read ($in);
  ...
  /** get the port for the endpoint of the locator
  	*/
  public int getEndpoint (String endPointType) throws org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPoint
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = _invoke ($out);
                int $result = org.jboss.com.sun.corba.se.PortableActivationIDL.TCPPortHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  /** Useful from external BadServerIdHandlers which need
  	...
  	*/
  public int getServerPortForType (org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORB location, String endPointType) throws org.jboss.com.sun.corba.se.PortableActivationIDL.NoSuchEndPoint
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getServerPortForType", true);
                org.jboss.com.sun.corba.se.PortableActivationIDL.LocatorPackage.ServerLocationPerORBHelper.write ($out, location);
                $out.write_string (endPointType);
                $in = _invoke ($out);
                int $result = org.jboss.com.sun.corba.se.PortableActivationIDL.TCPPortHelper.read ($in);
                return $result;
