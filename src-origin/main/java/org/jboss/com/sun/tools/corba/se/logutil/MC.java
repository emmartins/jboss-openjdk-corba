 ...
 * questions.
 */
package org.jboss.com.sun.tools.corba.se.logutil;
...
public class MC {
  ...
  private void writeClass(String inFile, String outDir, Input input)
    ...
    pw.println( "import org.jboss.com.sun.corba.se.impl.util.SUNVMCID ;");
    pw.println( "import org.omg.CORBA.CompletionStatus ;");
    pw.println( "import org.omg.CORBA.SystemException ;");
    pw.println();
    pw.println( "import org.jboss.com.sun.corba.se.spi.orb.ORB ;");
    pw.println();
    pw.println( "import org.jboss.com.sun.corba.se.spi.logging.LogWrapperFactory;");
    pw.println();
    pw.println( "import org.jboss.com.sun.corba.se.spi.logging.LogWrapperBase;");
    pw.println();
