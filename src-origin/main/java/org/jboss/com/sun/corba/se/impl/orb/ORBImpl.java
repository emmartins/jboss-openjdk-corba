...
import org.jboss.com.sun.corba.se.spi.orb.DataCollector;
import org.jboss.com.sun.corba.se.spi.orb.Operation;
import org.jboss.com.sun.corba.se.spi.orb.ORBData;
import org.jboss.com.sun.corba.se.spi.orb.ORBConfigurator;
import org.jboss.com.sun.corba.se.spi.orb.ParserImplBase;
import org.jboss.com.sun.corba.se.spi.orb.PropertyParser;
import org.jboss.com.sun.corba.se.spi.orb.OperationFactory;
...
import org.jboss.com.sun.corba.se.spi.protocol.RequestDispatcherDefault;
...
import org.jboss.com.sun.corba.se.impl.corba.NVListImpl;
import org.jboss.com.sun.corba.se.impl.corba.ExceptionListImpl;
import org.jboss.com.sun.corba.se.impl.corba.ContextListImpl;
import org.jboss.com.sun.corba.se.impl.corba.NamedValueImpl;
import org.jboss.com.sun.corba.se.impl.corba.EnvironmentImpl;
import org.jboss.com.sun.corba.se.impl.corba.AsynchInvoke;
import org.jboss.com.sun.corba.se.impl.corba.AnyImpl;
import org.jboss.com.sun.corba.se.impl.corba.RequestImpl;
import org.jboss.com.sun.corba.se.impl.dynamicany.DynAnyFactoryImpl;
...
import org.jboss.com.sun.corba.se.impl.interceptors.PIHandlerImpl;
import org.jboss.com.sun.corba.se.impl.interceptors.PINoOpHandlerImpl;
import org.jboss.com.sun.corba.se.impl.ior.TaggedComponentFactoryFinderImpl;
import org.jboss.com.sun.corba.se.impl.ior.TaggedProfileFactoryFinderImpl;
import org.jboss.com.sun.corba.se.impl.ior.TaggedProfileTemplateFactoryFinderImpl;
import org.jboss.com.sun.corba.se.impl.oa.toa.TOAFactory;
...
import org.jboss.com.sun.corba.se.impl.orbutil.StackImpl;
import org.jboss.com.sun.corba.se.impl.orbutil.threadpool.ThreadPoolImpl;
import org.jboss.com.sun.corba.se.impl.orbutil.threadpool.ThreadPoolManagerImpl;
import org.jboss.com.sun.corba.se.impl.protocol.RequestDispatcherRegistryImpl;
import org.jboss.com.sun.corba.se.impl.protocol.CorbaInvocationInfo;
import org.jboss.com.sun.corba.se.impl.transport.CorbaTransportManagerImpl;
import org.jboss.com.sun.corba.se.impl.legacy.connection.LegacyServerSocketManagerImpl;
import org.jboss.com.sun.corba.se.impl.util.Utility;
import org.jboss.com.sun.corba.se.impl.logging.ORBUtilSystemException;
import org.jboss.com.sun.corba.se.impl.copyobject.CopierManagerImpl;
import org.jboss.com.sun.corba.se.impl.presentation.rmi.PresentationManagerImpl;

/**
 * The JavaIDL ORB implementation.
 */
public class ORBImpl extends org.jboss.com.sun.corba.se.spi.orb.ORB
{
    ...
    public synchronized void send_multiple_requests_deferred(Request[] req)
    {
        ...
        for (int i = 0; i < req.length; i++) {
            AsynchInvoke invokeObject = new AsynchInvoke( this,
                (org.jboss.com.sun.corba.se.impl.corba.RequestImpl)req[i], true);
