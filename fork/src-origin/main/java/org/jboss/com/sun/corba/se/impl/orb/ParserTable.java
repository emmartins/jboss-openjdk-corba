...
import org.jboss.com.sun.corba.se.spi.orb.ParserData ;
import org.jboss.com.sun.corba.se.spi.orb.ParserDataFactory ;
...
import org.jboss.com.sun.corba.se.impl.transport.DefaultIORToSocketInfoImpl;
import org.jboss.com.sun.corba.se.impl.transport.DefaultSocketFactoryImpl;
...
public class ParserTable {
    ...
    public static final class TestLegacyORBSocketFactory
        implements org.jboss.com.sun.corba.se.spi.legacy.connection.ORBSocketFactory
    {
        public boolean equals( Object other )
        {
    ...
    public static final class TestORBSocketFactory
        implements org.jboss.com.sun.corba.se.spi.transport.ORBSocketFactory
    {
        public boolean equals( Object other )
        {
        ...
        Operation sfop = new Operation() {
            public Object operate( Object value )
            {
                ...
                try {
                    ...
                    if (org.jboss.com.sun.corba.se.spi.legacy.connection.ORBSocketFactory.class.isAssignableFrom(legacySocketFactoryClass)) {
        ...
        Operation sfop = new Operation() {
            public Object operate( Object value )
            {
                ...
                try {
                    ...
                    // this socket factory class is not one that would fail
                    // the class cast anyway.
                    if (org.jboss.com.sun.corba.se.spi.transport.ORBSocketFactory.class.isAssignableFrom(socketFactoryClass)) {
