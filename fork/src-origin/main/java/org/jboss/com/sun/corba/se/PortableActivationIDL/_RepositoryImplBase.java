...
/**
* org.jboss.com.sun.corba/se/PortableActivationIDL/_RepositoryImplBase.java .
...
public abstract class _RepositoryImplBase extends org.omg.CORBA.portable.ObjectImpl
                implements org.jboss.com.sun.corba.se.PortableActivationIDL.Repository, org.omg.CORBA.portable.InvokeHandler
{
  ...
  /** register server definition.
  	...
  	*/
       ...
       {
         try {
           org.jboss.com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef serverDef = org.jboss.com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDefHelper.read (in);
           String $result = null;
           $result = this.registerServer (serverDef);
           out = $rh.createReply();
           out.write_string ($result);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerAlreadyRegisteredHelper.write (out, $ex);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.BadServerDefinition $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.BadServerDefinitionHelper.write (out, $ex);
         }
         break;
       }
  ...
  /** get server definition
  	*/
       case 2:  // PortableActivationIDL/Repository/getServer
       {
         try {
           String serverId = org.omg.PortableInterceptor.ServerIdHelper.read (in);
           org.jboss.com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef $result = null;
           $result = this.getServer (serverId);
           out = $rh.createReply();
           org.jboss.com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDefHelper.write (out, $result);
         } catch (org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegistered $ex) {
           out = $rh.createExceptionReply ();
           org.jboss.com.sun.corba.se.PortableActivationIDL.ServerNotRegisteredHelper.write (out, $ex);
         }
  ...
  /** Returns list of ALL applicationNames defined in ServerDefs of registered 
  	...
  	*/
       case 7:  // PortableActivationIDL/Repository/getApplicationNames
       {
         ...
         out = $rh.createReply();
         org.jboss.com.sun.corba.se.PortableActivationIDL.RepositoryPackage.AppNamesHelper.write (out, $result);
         break;
       }
