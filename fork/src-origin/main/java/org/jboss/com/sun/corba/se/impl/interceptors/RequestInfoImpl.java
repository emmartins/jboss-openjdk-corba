...
import org.jboss.com.sun.corba.se.spi.legacy.connection.Connection;

import org.jboss.com.sun.corba.se.spi.legacy.interceptor.RequestInfoExt;
...
import org.jboss.com.sun.corba.se.spi.servicecontext.UnknownServiceContext;
...
import org.jboss.com.sun.corba.se.impl.logging.InterceptorsSystemException;
    ...
    implements RequestInfo, RequestInfoExt
{
     ...
     */
    public org.jboss.com.sun.corba.se.spi.legacy.connection.Connection connection()
    {
        return connection;
    }
                            ...
                            ServiceContexts serviceContexts, int id )
    {
        ...
        if( result == null ) {
            ...
            org.jboss.com.sun.corba.se.spi.servicecontext.ServiceContext context =
