 ...
 * <dl>
 * <dt>symtabFactory
 * <dd>If you wish to extend the symbol table entries, this method must return the factory which constructs those extensions.  If you only want to extend a few of the symbol table entries, it may be useful to extend org.jboss.com.sun.tools.corba.se.idl.DefaultSymtabFactory and only override the pertinent methods.
 * <dt>exprFactory
 * <dd>If you wish to extend the expression classes, this method must return the factory which constructs those extensions.  If you only want to extend a few of the expression classes, it may be useful to extend org.jboss.com.sun.tools.corba.se.idl.constExpr.DefaultSymtabFactory and only override the pertinent methods.
 * <dt>arguments
 * <dd>If you wish to add additional arguments to the base set of arguments, extend org.jboss.com.sun.tools.corba.se.idl.Arguments and override this method to return that class.
 * <dt>languageKeywords
...
public class Factories
{
  ...
  public org.jboss.com.sun.tools.corba.se.idl.constExpr.ExprFactory exprFactory ()
  {
    return new org.jboss.com.sun.tools.corba.se.idl.constExpr.DefaultExprFactory ();
  } // exprFactory
